...
public class Seller {
	...
	public String insertSeller(String researcherId, String name, String emailaddress, String workOnProduct, String productCategory, String purposeOfResearch, String previousProducts) 
	 { 
		String output = ""; 
		try
		{ 
			...
			String query = " insert into Seller(`researcherId`,`name`,`emailaddress`,`workOnProduct`,`productCategory`,`purposeOfResearch`,`previousProducts`)"+ " values (?, ?, ?, ?, ?, ?, ?)"; 
	...
	public String updateSeller(String researcherId, String name, String emailaddress, String workOnProduct, String productCategory, String purposeOfResearch, String previousProducts)
	 	{ 
			String output = ""; 
			try
			{ 
				...
				// create a prepared statement
				String query = "UPDATE seller SET name=?,emailaddress=?,workOnProduct=?,productCategory=?,purposeOfResearch=?,previousProducts=? WHERE researcherId=?"; 
						PreparedStatement preparedStmt = con.prepareStatement(query); 
				// binding values
				...
				{ 
					output = "Error while updating the Seller details."; 
					System.err.println(e.getMessage()); 
				} 
			return output; 
	...
	public String deleteSeller(String researcherId) 
	 { 
		String output = ""; 
		try
		{ 
			...
			if (con == null) 
				...
				// create a prepared statement
				String query = "delete from Seller where researcherId=?"; 
				PreparedStatement preparedStmt = con.prepareStatement(query); 
				// binding values
				preparedStmt.setString(1, researcherId);
				// execute the statement
